...
const EuiIconLogoGcpMono = ({
    ...
    >
        ...
        <path d="M20.256 15.982c0-2.316-1.91-4.194-4.268-4.194-2.357 0-4.268 1.878-4.268 4.194 0 2.317 1.911 4.195 4.268 4.195 2.357 0 4.268-1.878 4.268-4.195" />
...
export const icon = EuiIconLogoGcpMono;