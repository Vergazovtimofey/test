...
import { htmlIdGenerator } from '../../../service/accessibility';
interface SVGRProps {
    title?: string;
    titleId?: string;
}
        ...
        >
            ...
            <g fill="none" fillRule="evenodd">
                ...
                <g transform="translate(1.613 19.003)">
                    <mask id={generateId('d')} fill="#fff">
                        <use xlinkHref={`#${generateId('c')}`} />
                    </mask>
                    <path
                        fill="#34A853"
                        fillRule="nonzero"
                ...
                <g transform="translate(0 8.784)">
                    <mask id={generateId('f')} fill="#fff">
                        <use xlinkHref={`#${generateId('e')}`} />
                    </mask>
                    <path
                        fill="#FBBC04"
                        fillRule="nonzero"
                ...
                <g transform="translate(1.613)">
                    <mask id={generateId('h')} fill="#fff">
                        <use xlinkHref={`#${generateId('g')}`} />
                    </mask>
                    <path
                        fill="#EA4335"
                        fillRule="nonzero"
